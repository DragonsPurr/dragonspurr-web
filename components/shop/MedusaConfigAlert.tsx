...
export function MedusaConfigAlert() {
  ...
  return (
    <div
      ...
      role="alert"
    >
      Medusa is not configured. Add <code className="text-sm">NEXT_PUBLIC_MEDUSA_PUBLISHABLE_KEY</code> to
      your environment (Medusa Admin → Settings → Publishable API Keys).
    </div>
  );
}
