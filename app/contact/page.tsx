...
export const metadata: Metadata = {
  title: 'Contact',
  description: 'Get in touch with Dragon\'s Purr Crafts and Sundry.',
};
  ...
  return (
    <div className="container mx-auto max-w-4xl">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <section className="rounded-lg border border-(--dp-gray-600) bg-black/40 p-6 md:p-8 space-y-4">
          <div className="flex justify-center">
            <BoxIcon icon={boxiconsContactPhone} width="4rem" height="4rem" />
          </div>
          <div className="flex justify-center"> 
            <h2 className="font-cinzel_decorative text-2xl text-(--dp-light-red)">
              Talk to us
            </h2>
          </div>
        ...
        <section className="rounded-lg border border-(--dp-gray-600) bg-black/40 p-6 md:p-8 space-y-4 flex flex-col">
          <div className="flex justify-center">
